...
-- CREATE TEMPORARY TABLE temp SELECT * FROM staff WHERE password is NOT NULL; ALTER TABLE temp drop column password;
...
-- CREATE TEMPORARY TABLE tempx SELECT * FROM staff WHERE password is NULL; ALTER TABLE tempx drop column password;
